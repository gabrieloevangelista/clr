...
>(({ className, ...props }, ref) => <SelectPrimitive.Value ref={ref} className={cn("text-sm", className)} {...props} />)
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-gray-100 focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 bg-white",
      className,
    )}
    {...props}
  >
